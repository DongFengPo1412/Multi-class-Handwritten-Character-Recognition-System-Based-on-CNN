```bash label=Bash
curl -i -k 'https://aip.baidubce.com/rest/2.0/ocr/v1/handwriting?access_token=【调用鉴权接口获取的token】' --data 'image=【图片Base64编码，需UrlEncode】' -H 'Content-Type:application/x-www-form-urlencoded'
```
```python label=Python
# encoding:utf-8
